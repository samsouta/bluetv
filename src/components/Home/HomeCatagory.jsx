...
const HomeCatagory = () => {
    const [HomeTapActive, setHomeTapActive] = useState(() => localStorage.getItem('HomeTapActive') || 'Video');
    const [HomeGernActive, setHomeGernActive] = useState(() => localStorage.getItem('HomeGernActive') || 'All');
